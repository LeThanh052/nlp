...
def build_lstm_model(vocab_size, max_len, embedding_dim=32):
    return Sequential(
        [
...
def main():
    ...
    # 2. Giu nguyen train/test split nhu Phan A
    ...
    print("=== PHAN B - LSTM TOY DEMO ===")
    print("Train texts:", x_train)
    print("Test texts :", x_test)
    print("y_train    :", y_train)
    print("y_test     :", y_test)

    # 3. Giu nguyen tokenizer va padding nhu Phan A
    max_words = 1000
    max_len = 10
